...
CREATE TABLE `interacciones` (
  ...
  KEY `FK_Interacciones_Prospecto` (`Prospecto_ID`),
  CONSTRAINT `FK_Interacciones_Prospecto` FOREIGN KEY (`Prospecto_ID`) REFERENCES `prospectos` (`Prospecto_ID`) ON DELETE CASCADE
